...
@new_recipes_flow = [:gitignore, :commit_existing_application, :rubyversion, :database, :gems, :layout, :deploy]
@update_recipes_flow = [:gitignore, :rubyversion, :database, :gems, :layout, :deploy]
